        ...
        messages: [
          {
            ...
            content: [
              ...
              'Prefer concise hints, debugging steps, and explanations that help the learner fix their own code.',
              'When the user asks for a hint, do not write replacement code. Give one or two conceptual clues only.',
              'If the user asks for a hint, your response must not contain a fenced code block.',
              'Do not provide a full final solution, corrected program, or replacement code unless the user explicitly asks for the solution, full code, or final answer.',
